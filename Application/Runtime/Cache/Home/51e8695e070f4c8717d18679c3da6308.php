        ...
        <div class="r main_right">
            ...
            <form class="main_right_con">
                ...
                <div class="login_bot reg_bot div_text_center reg_btn_font2">
                    <div class="cur login_bot_span_login login_bot_span_reg">立即支付</div>
                </div>
            </form>
        </div>
    </div>

    ...
    <ul>
        ...
        <div class="r main_right">
            <div class="main_right_title">
                <em></em>
                <span>业绩<a href="uu_yeji.html" class="yeji_span"> &gt; UU册业绩</a><a href="info_edit.html" class="yeji_span">>人员信息</a></span>
            </div>

            <div class="c">
                <!--<span class="yeji_con_span_line"></span>-->
                <!--<span class="yeji_con_span_search">人员详情</span>-->
                <!--<span class="yeji_con_span_line"></span>-->
                <div class="yeji_con_res info_con_res">
                    <div class="personal">
                        ...
                        <div class="personal_r">
                            ...
                            <div class="r_cont">
            <!--                    <?php if(($end != 0)): ?><div class="r_cont_p">
...
<script>
    //table_h
    var tab_h=$('.yeji_con_res .personal').height();
    var tab_h1=tab_h+64+58;
    var tab_h2=tab_h+100+380;
    $('.yeji_con_res').height(tab_h1+'px');
    $('.main_w').height(tab_h2+'px');
    !function(){
    ...
    $('.r_cont').height(r_h*(r_n-1)+21+'px').css('overflow','hidden');

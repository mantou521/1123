...
<div class="container_w main_w" style="height:1258px;">
    ...
    <ul>
        ...
        <li onOff='0' class="cur main_left_li_dif main_left_li4">
            ...
            <if>
                ...
                <li><a href="<?php echo U('Home/Member/travel_re');?>">旅游报单</a></li>
        ...
        <div class="r main_right">
            ...
            <div class="main_right_con kucun_con">
                <div class="kucun_con_hx">
                    <div class="l kucun_con_l">
                        <img src="/uufenxiao/Public/Home/images/kucun1.png" alt="">
                        <span class="kucun_span1">UU册名称</span>
                    </div>
                    <div class="r kucun_con_r">
                        <span  class="kucun_span2">库存：<em>818</em></span>
                    </div>
                </div>
                <div class="kucun_con_hx">
                    <div class="l kucun_con_l">

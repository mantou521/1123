    ...
    <form class="form form-horizontal" action="" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="" name="ausername" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="apassword" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="lo_submit" type="submit" class="btn  radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">

...
<article class="page-container">
	<form class="layui-form" action="<?php echo U('Mem/change_password');?>" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账户：</label>
			<div class="formControls col-xs-8 col-sm-9"> <?php echo ($test); ?> </div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
    ...
    layui.use('form', function(){
        ...
        form.on('submit(user)', function(data){
            ...
            var url = "<?php echo U('Mem/change_password');?>";

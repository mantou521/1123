...
<div class="page-container">
    <form action="<?php echo U('order_post');?>" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="total" id="" placeholder="" value="<?php echo ($list["total"]); ?>" class="input-text" style="width:90%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="time" value="<?php echo ($list["t"]); ?>" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" id="logmin" class="input-text Wdate" style="width:120px;"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" name="content" type="text/plain" style="width:100%;height:400px;"><?php echo ($list["remark"]); ?></script>
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    $(function(){
        var ue = UE.getEditor('editor',{serverUrl :'<?php echo U('Asset/Ueditor/upload');?>' });
    });
</script>
</body>
</html>
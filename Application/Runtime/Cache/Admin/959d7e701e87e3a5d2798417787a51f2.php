    ...
    <div class="page-container">
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <tbody>
                <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr class="text-c va-m">
...
<script type="text/javascript">
    ...
    $('.bg_img .bg_img_close').css('left',(bg_img-12)+'px');
    $('.per_a1').click(function(){
        var img_index=$(this).parents('.text-c').index();
        $('.bg').show();
        $('.bg_img .bg_img2').eq(img_index).show();

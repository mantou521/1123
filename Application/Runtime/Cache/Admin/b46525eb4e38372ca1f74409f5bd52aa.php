...
<div style="margin-left:0px;">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> uu册 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="product_add('添加产品','<?php echo U('Admin/Goods/product_add');?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <?php if(is_array($goods)): foreach($goods as $key=>$vo): ?><tr class="text-c va-m">
                        ...
                        <form name="form" method="post" action="/index.php/Admin/Goods/product_edit">
                            <input type="hidden" name="goods_id" value="<?php echo ($vo['goods_id']); ?>">
						<td class="td-manage"><a style="text-decoration:none" onClick="product_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a><i ><input class="Hui-iconfont" title="编辑" type="submit" name="member_edit" value="&#xe6df;"></i><a style="text-decoration:none" class="ml-5" onClick="product_del(this,'<?php echo ($vo["goods_id"]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                        </form>
...
function product_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
        ...
        $.ajax({
            url:"/index.php/Admin/Goods/product_delete",
            type:'post',
            data:{'id':id},
            dataType:'json',
        })

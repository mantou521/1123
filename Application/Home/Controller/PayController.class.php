...
//
        ...
        $subject = $order['id'];  //订单名称 //必填 通过支付页面的表单进行传递
        $total_fee = $order['total'];   //付款金额  //必填 通过支付页面的表单进行传递
        $body = I('type');  //订单描述 通过支付页面的表单进行传递
        ...
        */
        ...
        if($verify_result) {
            ...
            if($_POST['trade_status'] == 'TRADE_FINISHED') {
                //
                update_pay_status($parameter['out_trade_no'],$type); // 修改订单支付状态

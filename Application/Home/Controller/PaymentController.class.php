...
//        }
        ...
        // 导入具体的支付类文件                
        include_once  "Plugins/payment/alipay/alipay.class.php"; // D:\wamp\www\svn_\www\plugins\payment\alipay\alipayPayment.class.php
        $code = 'alipay'; // \alipay
...
//
            ...
            $order = $M->where("id = $order_id")->find();
...
//        }
        ...
        $order = M('travel_order')->where("order_sn = '{$result['order_sn']}'")->find();

...
{    
    ...
    function get_code($order, $config_value){
            ...
            $parameter = array(
                        ...
                        "extra_common_param"	=> 1, //商户订单号
                        "subject"	=> 'UU 商城', //订单名称 可以中文
                        "total_fee"	=> $order['total'], //付款金额
    ...
    {                
        ...
        logResult($verify_result);
            if($verify_result) //验证成功
            {
                    ...
                    $order_type = $_POST['extra_common_param']; //交易状态

                    // 支付宝解释: 交易成功且结束，即不可再做任何操作。
                    if($_POST['trade_status'] == 'TRADE_FINISHED') 
                    {                         
                          update_pay_status($order_sn,$order_type); // 修改订单支付状态
                    }
